...
# ----------------------------
# Per-statement validation (same checks as v2)
# ----------------------------
...
# ----------------------------
# Bundle-level validation (new schema)
# ----------------------------
def validate_bundle_json(bundle: dict) -> dict:
    """
    Validate the new multi-statement bundle:
      { "schema_version": "...", "client": "...", "statements": [ <statement> ... ] }
    Prints per-statement validation and returns an overall report.
    """
