...
from parsers.statement_boi_current import parse_boi_statement
from parsers.statement_revolut import parse_revolut_statement
...
def main():
    ...
    bank_code = "BOI"  # This could be auto-detected in the future
